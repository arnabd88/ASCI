...
\begin{document}
  ...
  \begin{equation}
	  f^{\prime\prime\prime}(x_0) = \dfrac{f(x_0 + 2h) - f(x_0 - 2h) - 2f(x_0 + h) + 2f(x_0-h)}{h^3} + \mathbf{\dfrac{-h^2}{4}f^{\prime\prime}(\zeta)}
	  \label{eq:3deriv}
  \end{equation}
  ...
  Thus, truncation error = $\mathbf{\dfrac{-h^2}{4}f^{\prime\prime}(\zeta)}$
