...
\question{3}{Chapter-8, question-8}
 ...
 Now the projection of $\bf v_3$, say $\bf y_3, $ on the span($\bf u_1, \bf u_2$), will be, \newline
 ...
 Thus $y_3$, comes out to be zero, when we encounter the linearly dependent vector. (Answer). \newline
